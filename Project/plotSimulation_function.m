function plotSimulation_function(states, states_est, centroids_est, numUAV, dimgrid, pos_est_fire1, x_fire1, y_fire1, sigma_est_fire1, curr_fire1_sig, x_fire2, y_fire2, sigma_fire2, x_water, y_water, sigma_water, dim_UAV, numfig)
