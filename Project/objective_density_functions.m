function [G_fires, G_water] = objective_density_functions(dimgrid,pos_fire1,pos_fire2,pos_water,sigma_fire1,sigma_fire2,sigma_water, PLOT_DENSITY_FUNCTIONS)
...
G_fires = exp(-(((x_m - pos_fire1(1)).^2) / (2 * sigma_fire1^2) + ((y_m - pos_fire1(2)).^2) / (2 * sigma_fire1^2))) + ...
...
if PLOT_DENSITY_FUNCTIONS
    ...
    text(pos_fire1(1), pos_fire1(2), zLabelHeight, 'Fire 1', 'Color', 'k', 'FontSize', 12, 'FontWeight', 'bold');
